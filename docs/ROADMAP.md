...
- Apply the same controller-to-feature reduction pass to `admin.js`, then to the remaining editor/workspace hotspots that still own too much orchestration locally.
